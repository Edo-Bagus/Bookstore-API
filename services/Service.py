...
from repository.ReviewsRepo import add_review, update_review
...
def delete_books_by_name_service(book_name):
    return delete_books_by_name(book_name)
...
def update_review_service(customer_name, book_name, description, rating):
    return update_review(customer_name, book_name, description, rating)